    ...
    return(
        ...
        <nav className="p-3 flex flex-wrap bg-home_color pd-20 justify-between items-center">
            ...
            <div className="container-md relative">
                <div className="mt-20 ml-20 mr-20 mb-20 pb-20">
                    <img className="h-25 w-50" src="blog2_read.png"></img>
                </div>
                ...
                The magic of colors, or the speech and importance of colors in marketing
                </div>
